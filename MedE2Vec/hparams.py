...
class Hparams:
    ...
    #input
    parser.add_argument('--n_input', default=10468, type=int)
    parser.add_argument('--maxlen_seqs', default=104, type=int,help="max length of input event")
    #model
    parser.add_argument('--d_model', default=512, type=int,help="dimension of entity embedding")
    parser.add_argument('--d_ff', default=2048, type=int, help="number of neurons of feedword network")
